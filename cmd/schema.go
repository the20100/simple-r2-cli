...
With no argument, dumps all commands. With an argument (e.g. "objects.list"),
...
Examples:
  r2 schema                  # all commands
  r2 schema objects.list     # one command`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if !ok {
			return fmt.Errorf("unknown command %q — run 'r2 schema' to see all", args[0])
		}
