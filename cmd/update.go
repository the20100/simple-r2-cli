...
const repoURL = "https://github.com/the20100/simple-r2-cli"

var updateCmd = &cobra.Command{
	Use:   "update",
	Short: "Update r2 to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "r2-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "r2")
